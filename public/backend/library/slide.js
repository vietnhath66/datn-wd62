(function ($) {
    ...
    HT.addSlide = () => {
        $(document).on("click", ".addSlide", function (e) {
            e.preventDefault();
            $(".slide-list").append(HT.renderSlideItemHtml());
         ...
         <div class="col-lg-12 ui-state-default">
                <div class="slide-item">
                    <div class="row custom-row">
                        ...
                        <label for="file-upload ${id}" class="slide-image img-cover"> <svg style="width:100px;height:100px;fill: #d3dbe2;margin-bottom: 10px;"
                            ...
                            <input id="file-upload ${id}" type="file" style="display:none" name="slide[image][]"/>
                        ...
                        <div class="col-lg-9">
                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#${tab_1}" aria-expanded="true"> Thông
                                            tin chung</a></li>
                                    <li class=""><a data-toggle="tab" href="#${tab_2}" aria-expanded="false">SEO</a>
                                    </li>
                                </ul>
