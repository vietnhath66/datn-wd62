    ...
    <tbody>
        @if (isset($attributes) && is_object($attributes))
            ...
            <tr >
                ...
                <td>
                    {{ str_repeat('|----', (($attribute->level > 0)?($attribute->level - 1):0)).$attribute->name }}
                </td>
                @include('backend.dashboard.components.languageTd', ['model' => $attribute, 'modeling' => 'ProductCatalogue'])
                ...
                <td class="text-center"> 
                    <a href="{{ route('admin.product_catalogue.edit', $attribute) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                    <a href="{{ route('admin.product_catalogue.delete', $attribute) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        @endif
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    <li
                        ...
                        <a href="#!" class="text-slate-400 dark:text-zink-200">Thuộc tính</a>
                    </li>
                                    ...
                                    @foreach ($attributes as $attribute)
                                        <tr>
                                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                {{ str_repeat('|----', $attribute->level > 0 ? $attribute->level - 1 : 0) }}
                                                <a href="#!"
                                                    class="transition-all duration-150 ease-linear product_code text-custom-500 hover:text-custom-600">{{ $attribute->id }}</a>
                                            </td>
                                            <td
                    ...
                    <div class="flex flex-col items-center gap-4 px-4 mt-4 md:flex-row" id="pagination-element">
                        ...
                        <div class="col-sm-auto mt-sm-0">
                            <div class="flex gap-2 pagination-wrap justify-content-center">
                                ...
                                <a class="inline-flex items-center justify-center bg-white dark:bg-zink-700 h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zink-500 text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 hover:bg-custom-50 dark:hover:bg-custom-500/10 focus:bg-custom-50 dark:focus:bg-custom-500/10 focus:text-custom-500 dark:focus:text-custom-500 [&.active]:text-custom-500 dark:[&.active]:text-custom-500 [&.active]:bg-custom-50 dark:[&.active]:bg-custom-500/10 [&.active]:border-custom-50 dark:[&.active]:border-custom-500/10 [&.active]:hover:text-custom-700 dark:[&.active]:hover:text-custom-700 [&.disabled]:text-slate-400 dark:[&.disabled]:text-zink-300 [&.disabled]:cursor-auto page-attribute pagination-next"
                                    href="javascript:void(0)">
