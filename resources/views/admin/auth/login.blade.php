        ...
        <div class="!px-10 !py-12 card-body">
            ...
            <form class="mt-10" role="form" action="{{ route('auth.login') }}" method="POST">
                ...
                <div
                    ...
                    <h5 class="inline-block px-2 py-0.5 text-sm bg-white text-slate-500 rounded relative">
                        Sign In with</h5>
                </div>
                ...
                <div class="mt-10 text-center">
                    <p class="mb-0 text-slate-500">Don't have an account ? <a href="auth-register-basic.html"
