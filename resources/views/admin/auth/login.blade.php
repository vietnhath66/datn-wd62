...
<body
        ...
        <div class="!px-10 !py-12 card-body">
            ...
            <form class="mt-10" role="form" action="{{ route('auth.login') }}" method="POST">
                ...
                <div class="mt-3">
                    ...
                    <input type="password" class="form-input dark:bg-zink-600/50 border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Password" name="password">
                    @error('password')
                        <span class="text-danger font-italic">* {{ $message }}</span>
                    @enderror
                </div>
    ...
    <script src='../theme/admin/html/assets/libs/choices.js/public/../theme/admin/html/assets/scripts/choices.min.js'>
    </script>
    <script src="../theme/admin/html/assets/libs/%40popperjs/core/umd/popper.min.js"></script>
    <script src="../theme/admin/html/assets/libs/tippy.js/tippy-bundle.umd.min.js"></script>
    <script src="../theme/admin/html/assets/libs/simplebar/simplebar.min.js"></script>
    <script src="../theme/admin/html/assets/libs/prismjs/prism.js"></script>
    <script src="../theme/admin/html/assets/libs/lucide/umd/lucide.js"></script>
    <script src="../theme/admin/html/assets/js/starcode.bundle.js"></script>
    <script src="../theme/admin/html/assets/js/pages/auth-login.init.js"></script>
