            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <p class="text-slate-500 dark:text-zink-200">Đơn hàng đã giao</p>
                    </div>
                </div>
                <!--end col-->
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                        ...
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="images/avatar-2.png" alt="" class="w-8 h-8 rounded-full" />
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="images/avatar-3.png" alt="" class="w-8 h-8 rounded-full" />
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="images/avatar-4.png" alt="" class="w-8 h-8 rounded-full" />
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="images/avatar-5.png" alt="" class="w-8 h-8 rounded-full" />
                                </div>
                                <div class="grow">
