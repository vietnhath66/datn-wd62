...
select.selectVariant {
    appearance: none; /* Ẩn UI mặc định của trình duyệt */
    background-color: #fff;
...
select.selectVariant:focus {
    border-color: #2563eb; /* xanh dương nhạt khi focus */
    outline: none;
...
.variant-box .text-danger {
    color: #dc2626; /* màu đỏ cho "màu sắc", "size" */
}
...
.updateVariant {
    background-color: #e5e5e5; /* màu nền xám */
    padding: 20px;
    border-radius: 6px;
    margin-top: 10px;
}
    ...
    <div class="ibox variant-box">
        <div class="ibox-title">
            ...
            <div class="description">Cho phép bạn bán các phiên bản khác nhau của sản phẩm, ví dụ: : quần, áo thì có các
                <strong class="text-danger">màu sắc</strong> và <strong class="text-danger">size</strong> số khác nhau.
                Mỗi
