    ...
    <div class="container" id="container">
        <div class="sign-in">
            <form action="" method="POST">
                ...
                <p style="">Hãy đặt lại mật khẩu của bạn tại đây</p>
                <input type="password" name="password" placeholder="Nhập mật khẩu mới của bạn" />
                <button style="margin-top: 20px">Xác nhận</button>
            </form>
        </div>
