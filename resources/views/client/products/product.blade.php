    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll(".filter-tope-group button").forEach(button => {
            button.addEventListener("click", function () {
                ...
                let products = document.querySelectorAll(".isotope-grid");
                ...
                document.querySelectorAll(".filter-tope-group button").forEach(btn => btn.classList.remove("how-active1"));
        ...
        document.querySelectorAll(".filter-btn").forEach(button => {
            button.addEventListener("click", function () {
                ...
                let products = Array.from(productContainer.querySelectorAll(".product-item"));
                ...
                products.sort((a, b) => {
                    if (sortType.includes("name")) {
                        ...
                        return sortType === "name_asc" ? nameA.localeCompare(nameB) : nameB.localeCompare(nameA);
                ...
                // Xóa các sản phẩm cũ và thêm sản phẩm đã sắp xếp vào lại
