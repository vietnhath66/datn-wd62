...
.logo-text {
  font-size: 2rem;
  font-weight: 700;
  color: #ad7a53; /* Màu vàng đất sang trọng */
...
<div class="section-header-sale" style="text-align:center; margin: 20px 0;">
    ...
    <h3 style="color: #ff6600; font-weight: 700; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 1.8rem; display: inline-flex; align-items: center; gap: 10px; text-transform: uppercase; letter-spacing: 1.2px;">
...
.section-header-sale h3 {
    color: #c0392b; /* Màu đỏ đậm, nổi bật */
    font-weight: 700;
    letter-spacing: 0.05em;
}

.section-header-sale hr {
    border-color: #e74c3c; /* Đường kẻ màu đỏ nhẹ tạo điểm nhấn */
    margin: 10px 0;
}
</style>
...
.btn-black:hover {
    background-color: #333;      /* Màu nền đen nhạt khi hover */
    color: #fff;
}
</style>
    ...
    <h3 style="color: #e74c3c; font-weight: 700; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 1.8rem; display: inline-flex; align-items: center; gap: 10px; text-transform: uppercase; letter-spacing: 1.2px;">
...
.btn-view-all {
    display: inline-block;
    background-color: #e74c3c; /* hoặc màu khác tùy loại */
    color: #fff;
    padding: 10px 20px;
    border-radius: 4px;
    font-weight: 600;
