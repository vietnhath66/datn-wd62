        ...
        <div class="row isotope-grid">
            ...
            @php
                    ...
                    foreach ($product->variants as $variant) {
                        if ($variant->name_variant_color) {
                            $colorClasses .= ' color-' . Str::slug($variant->name_variant_color);
                        }
                        if ($variant->name_variant_size) {
                            $sizeClasses .= ' size-' . Str::slug($variant->name_variant_size);
                        }
                    }
                @endphp
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women {{ $colorClasses }} {{ $sizeClasses }}">
                    <!-- Block2 -->
                    <div class="block2">
